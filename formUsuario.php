...
<section class="py-5" id="Cadastro">
    ...
    <div class="d-flex justify-content-center mb-3"  >
        ...
        <div class="row">
            <div class="col">
                ...
                <h2 id="Cadastro" >Cadastro de Usuário:</h2>
                ...
                <form action="actionUsuario.php" method="POST" class="was-validated" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <input type="date" class="form-control" id="dataNascimentoUsuario"
                            placeholder="dataNascimentoUsuario" name="dataNascimentoUsuario" required>
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <input type="email" class="form-control" id="emailUsuario" placeholder="Email"
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <input type="password" class="form-control" id="senhaUsuario" placeholder="Email"
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <input type="password" class="form-control" id="confirmarSenhaUsuario"
                            placeholder="Confirmar Senha" name="confirmarSenhaUsuario" required>
