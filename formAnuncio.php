        ...
        <div class="row">
            <div class="col">
                ...
                <form action="actionAnuncio.php" method="POST" class="was-validated" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <input type="text" class="form-control" id="tituloAnuncio" placeholder="Título do Anúncio"
                            name="tituloAnuncio">
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <select class="form-select" id="categoriaAnuncio" name="categoriaAnuncio"
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <textarea class="form-control" id="descricaoAnuncio"
                            placeholder="Informe uma breve descrição sobre o seu anúncio"
                            name="descricaoAnuncio"></textarea>
                    ...
                    <div class="form-floating mt-3 mb-3">
                        <input type="text" class="form-control" id="valorAnuncio" placeholder="Valor do Anúncio"
                            name="valorAnuncio">
